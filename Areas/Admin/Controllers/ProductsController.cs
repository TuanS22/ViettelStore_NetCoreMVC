...
using viettel_store.Models; // nhìn thấy thư mục Model
using X.PagedList;  // phân trang
using viettel_store.Areas.Admin.Attributes; // để nhìn thấy file CheckLogin.cs
...
namespace viettel_store.Areas.Admin.Controllers
{
    ...
    public class ProductsController : Controller
    {
        ...
        {
            // tạo biến action để đưa vào thuộc tính action trong thẻ from
            ViewBag.action = "/Admin/Products/UpdatePost/" + id;
            // lấy 1 bản ghi tương ứng vs id
